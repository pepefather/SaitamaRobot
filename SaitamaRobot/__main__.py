...
I'm the famous vice president of your favourite anime "High School DXD". I help admins manage their groups with One Kiss! Have a look at the following for an idea of some of \
                ...
                reply_markup=InlineKeyboardMarkup(
                    [[
                        InlineKeyboardButton(
                            text="☑️ Add Akeno to your group",
                     ...
                     [
                         InlineKeyboardButton(
                             text="🗄 Source code",
                             url="https://github.com/pepefather/SaitamaRobot")
                     ]]))
    else:
